...
public class Z implements TetrisPiece {
	private Position[] piecePositions=new Position[4];
	private char type='S';
	private int orientation=1; //2 orientations for Z-block.
	private String color="blue";
	private int UNIT;
	private int WIDTH;
	private int HEIGHT;
	
	public Z(int UNIT,int WIDTH,int HEIGHT) {
		this.UNIT=UNIT;
		this.WIDTH=WIDTH;
		this.HEIGHT=HEIGHT;
	...
	public Z(TetrisPiece anotherPiece) {
		piecePositions[0]=new Position();
		piecePositions[1]=new Position();
		piecePositions[2]=new Position();
		piecePositions[3]=new Position();
