...
public class S implements TetrisPiece {
	private Position[] piecePositions=new Position[4];
	private char type='S';
	private int orientation=1; //2 orientations for S-block.
	private String color="green";
	private int UNIT;
	private int WIDTH;
	private int HEIGHT;
	
	public S(int UNIT,int WIDTH,int HEIGHT) {
		this.UNIT=UNIT;
		this.WIDTH=WIDTH;
		this.HEIGHT=HEIGHT;
		...
		piecePositions[2].x=piecePositions[1].x;
	...
	public S(TetrisPiece anotherPiece) {
		piecePositions[0]=new Position();
		piecePositions[1]=new Position();
		piecePositions[2]=new Position();
		piecePositions[3]=new Position();
	...
	public void rotate() {
		...
		case 1: //vado in orientazione 2.
			...
			piecePositions[0].x+=0; //doesnt change
